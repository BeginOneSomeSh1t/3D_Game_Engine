...
DxgiInfoManager::DxgiInfoManager()
{
	...
	const auto hModDxgiDebug = LoadLibraryEx(CHARTOWCHAR("dxgidebug.dll"), nullptr, LOAD_LIBRARY_SEARCH_SYSTEM32);
...
std::vector<std::string> DxgiInfoManager::GetMessages() const
{
	...
	for (auto i = next; i < end; i++)
	{
		...
		// get the message and pu8sh its description into the vector
