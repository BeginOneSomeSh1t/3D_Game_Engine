	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	if (!IsStaticInitialized())
	{
		...
		AddStaticBind(std::make_unique<Texture>(gfx, Surface::FromFile("Images\\Mica.jpg")));
		...
		AddStaticBind(std::make_unique<PixelConstBuffer<PSMaterialConstant>>(gfx, colorConst, 1u));
	}
	else
	{
